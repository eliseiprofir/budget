...
def test_analytics_historical_serializer(
    ...
    assert serializer_data["yearly"]["2025"]["balance"]["_total"] == decimal.Decimal("200.00")
    ...
    assert serializer_data["yearly"]["2026"]["balance"]["_total"] == decimal.Decimal("100.00")
    ...
    assert serializer_data["summary"]["balance"]["_total"] == decimal.Decimal("300.00")
